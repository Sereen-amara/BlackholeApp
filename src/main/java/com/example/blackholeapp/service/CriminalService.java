...
public class CriminalService {
    ...
    public Criminal addCriminal(Criminal criminal) {
        logger.info("Adding a new criminal to the database.");
    ...
    public List<Criminal> searchCriminals(String query) {
        logger.info("Searching criminals with sanitized query input.");
        // Prevent SQL Injection by relying on repository methods that sanitize inputs
